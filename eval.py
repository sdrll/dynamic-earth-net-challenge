...
# test_dataset = ChangeDetectionDataset(planet_test_boxes_path, transform=None, train=False)
# weights = torch.FloatTensor(train_dataset.weights).cuda()

net.load_state_dict(torch.load('./weights/test7epochs'))
net.eval()
net.cuda()
...
for planet_test_folder_name in tqdm(os.listdir(planet_test_boxes_path)):
    ...
    if planet_test_folder_name != '38S':
